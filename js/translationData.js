...
class Translator {
    ...
    constructor() {
        ...
        city("Saint-Alban-du-Rhône", "Saint-Alban-du-Rhône", "생 알방 듀 혼느")
        city("St.Alban", "St.Alban", "생 알방")
        city("Amsterdam", "Amsterdam", "암스테르담")
        city("Bacău", "Bacău", "바커우")
        ...
        city("Düsseldorf", "Düsseldorf", "뒤셀도르프")
        ...
        city("Galați", "Galați", "갈라치")
        city("Gdańsk", "Gdańsk", "그단스크")
        ...
        city("İstanbul", "İstanbul", "이스탄불")
        city("Jönköping", "Jönköping", "옌셰핑")
        city("Калининград", "Kaliningrad", "칼리닌그라드")
        city("Kalmar", "Kalmar", "칼마르")
        city("Kapellskär", "Kapellskär", "카펠스카")
        ...
        city("Liège", "Liège", "리에주")
        city("Liepāja", "Liepāja", "리예파야")
        city("L'Île-Rousse", "L'Île-Rousse", "릴후스")
        city("Lille", "Lille", "릴")
        city("Limoges", "Limoges", "리모주")
        city("Linköping", "Linköping", "린셰핑")
        city("Linz", "Linz", "린츠")
        ...
        city("Mažeikiai", "Mažeikiai", "마제이카이아이")
        city("Metz", "Metz", "메스")
        ...
        city("Šiauliai", "Šiauliai", "시아울리아이")
        city("Södertälje", "Södertälje", "쇠데르텔리에")
        ...
        city("Târgu Mureș", "Târgu Mureș", "트르구무레슈")
        city("Tartu", "Tartu", "타르투")
        city("Tekirdağ", "Tekirdağ", "테키르다")
        city("Timișoara", "Timișoara", "티미쇼아라")
        city("Torino", "Turin", "토리노")
        city("Toulouse", "Toulouse", "툴루즈")
        city("Travemünde", "Travemünde", "트라베뮌데")
        ...
        city("Wrocław", "Wrocław", "브로츠와프")
        city("Zürich", "Zürich", "취리히")
...
$(document).ready(() => {
    ...
    $("#postTrip").click(() => {
        ...
        while (getMessageContent(false).length > 800) {
            imageSizeOnce--;
            if (imageSizeOnce == 1) {
                alert("URL이 지나치게 깁니다.");
                $("#postTrip").text("게시!");
